        ...
        <div className="max-w-3xl w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-5 text-xl text-gray-500">
              Save links and automatically organize them with AI-powered summaries for easy retrieval later.
            </p>
          </div>
            ...
            <div className="rounded-lg bg-gray-50 p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="ml-4 text-gray-600">Share any URL from your device or add it directly in the app</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <span className="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold">2</span>
                  </div>
                  <p className="ml-4 text-gray-600">Our system uses AI to automatically generate a concise summary and relevant tags</p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <span className="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold">3</span>
                  </div>
                  <p className="ml-4 text-gray-600">Access your knowledge base anytime with powerful search and filtering</p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Knowledge Base
          </p>
        </div>
      </footer>
    </div>
